...
public class HotProductAdapter extends RecyclerView.Adapter<HotProductAdapter.ViewHolder> {
    ...
    private List<HotProductModels> list;

    public HotProductAdapter(Context context, List<HotProductModels> list) {
    ...
    public HotProductAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.hot_products,parent,false));
